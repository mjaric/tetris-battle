...
export function calculateCellSize(playerCount: number, viewportWidth: number): number {
  ...
  const raw = Math.floor((perBoard - GARBAGE_METER_EXTRA - BORDER_EXTRA) / BOARD_COLUMNS);
